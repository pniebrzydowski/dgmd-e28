...
itemPrices["hot dogs"] = 400;
itemPrices["fries"] = 350;
itemPrices["soda"] = 150;
itemPrices["sauerkraut"] = 100;
...
const calculateOrder = ($form) => {
  ...
  const orderQuantities = new Array();
  orderQuantities["hot dogs"] = parseInt(inputs.hotdog.value, 10);
  orderQuantities["fries"] = parseInt(inputs.fries.value, 10);
  orderQuantities["soda"] = parseInt(inputs.soda.value, 10);
  orderQuantities["sauerkraut"] = parseInt(inputs.sauerkraut.value, 10);
